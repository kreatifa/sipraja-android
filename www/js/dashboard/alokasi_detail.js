var alokasi_detail = {
  name: 'alokasi_detail',
  path: '/alokasi_detail/:id',
  url: './pages/dashboard/alokasi_detail.html',
  options: {
    ...
    pageInit: function() {
      ...
      var datatables = $('#tabel_detail_alokasi').DataTable({
        ...
        rowCallback: function (row, data) {
          ...
          $('td:eq(4)', row).html('<a href="/alokasi_detail_list/' + data.id + '" class="button button-small button-fill color-green"><i class="icon f7-icons" style="font-size: 12pt;">search</i> Lihat</a>');
        }
      })
    }
  }
...
var alokasi_detail_list = {
  name: 'alokasi_detail_list',
  path: '/alokasi_detail_list/:id',
  url: './pages/dashboard/alokasi_detail_list.html',
  options: {
    transition: 'f7-circle',
  },
  on: {
