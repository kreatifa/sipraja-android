var json_paket_data = {
  ...
  "data": [
    { "harga": "900", "admin": "100", "kode_produk": "P001", "produk": "Data Pure 100MB 30H", "group_produk": "INDOSAT", "status": "AKTIF" },
    { "harga": "1750", "admin": "100", "kode_produk": "P002", "produk": "Data Pure 200MB 30H", "group_produk": "INDOSAT", "status": "AKTIF" },
    { "harga": "3950", "admin": "100", "kode_produk": "P003", "produk": "Data Pure 1GB 1H", "group_produk": "INDOSAT", "status": "AKTIF" },
    { "harga": "4100", "admin": "0", "kode_produk": "P004", "produk": "Data Pure 500MB 30H", "group_produk": "INDOSAT", "status": "AKTIF" }
  ]
};
                ...
                $$('#list-product-' + index).on('click', function () {
                  ...
                  app.dialog.confirm(
                    ...
                    function () {
                      ...
                      app.request.post(site_url_mobile_layanan + '/tipe_e/pembayaran_paket_data', ajax_data, function (data) {
                        app.dialog.close();
