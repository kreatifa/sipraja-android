  ...
  on: {
    pageInit: function () {
      ...
      $$('#bayar').on('click', function () {
        app.dialog.confirm(
          'Apakah anda yakin ingin membayar tagihan BPJS dengan ID Pelanggan ' + $$('#id').val() +
          ...
          function () {
            ...
            app.dialog.preloader('Loading...');
            app.request.post(site_url_mobile_layanan + '/tipe_e/pembayaran_bpjs', ajax_data, function (data) {
              app.dialog.close();
