  ...
  on: {
    pageInit: function () {
      ...
      $$('#bayar').on('click', function () {
        app.dialog.confirm(
          'Apakah anda yakin ingin membayar tagihan SELULER PASCABAYAR dengan Nomor Telepon ' + $$('#id').val() +
          ...
          function () {
            ...
            app.dialog.preloader('Loading...');
            app.request.post(site_url_mobile_layanan + '/tipe_e/pembayaran_seluler_pascabayar', ajax_data, function (data) {
              app.dialog.close();
