...
function add_attachment_pendaftar(attachments) {
  attachments.forEach(function (attachment) {
    if (attachment) {
      var formupload_html =
        `<li data-index="${counter}">
          <ul>
                  ...
                  <div class="col-60">
                    <div class="item-inner">
                      <div class="item-input-wrap">
                        ...
                        <input class="file_creds" id="file_creds${counter}" type="hidden" readonly name="file_creds[]">
                        <input class="fileurl" value="${attachment.file_name}" id="fileurl${counter}" type="text" readonly name="fileurl[${counter}]" placeholder="URL file">
                      </div>
                    </div>
                  </div>
                  <div class="col-20 preview_files">
                    <a id="preview_pas_foto_button" onclick="preview_ktp(${attachment.id})" class="button button-round button-fill color-orange" style="margin-top: 10px;">
              ...
              <div class="item-inner">
                <div class="row">
                  <div class="col-80">
                    <div class="item-inner">
                      <div class="item-input-wrap">
                        <input type="text" value="${attachment.desc}" readonly class="file_cred" name="file_cred[]" placeholder="Keterangan File">
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <li class="item-content item-input">
            <div class="item-inner">
              <div class="row">
                <div class="col-60">
                  <div class="item-inner">
                    <div class="item-input-wrap">
                      ...
                      <input class="fileurl" id="fileurl${counter}" type="text" readonly name="fileurl[${counter}]" placeholder="URL file">
                    </div>
                  </div>
                </div>
                <div class="col-20 preview_files">
                ...
                <div class="col-20">
                  <a id="${counter}" onclick="uploadfile(this.id)" class="button button-round button-fill" style="margin-top: 10px;">
          ...
          <li class="item-content item-input">
            <div class="item-inner">
              <div class="row">
                ...
                <div class="col-20">
                  <a id="${counter}" onclick="deleterow(this.id)" class="button button-round button-fill color-red" style="margin-top: 10px;">
                    <i class="f7-icons" style="font-size: 16pt; margin-top: 7px;">trash_fill</i>
                  </a>
                </div>
              </div>
            </div>
...
function add_row_kerja() {
  var html =
    `<li class="item-content item-input">
      <div class="item-inner">
        <div class="item-input-wrap">
          <div class="item-title item-label">Jabatan</div>
          <input type="text" name="jabatan[${counter}]">
    ...
    <li class="item-content item-input">
      <div class="item-inner">
        <div class="item-input-wrap">
          ...
          <input type="text" name="uraian_tugas[${counter}]">
          <span class="input-clear-button"></span>
        </div>
      </div>
    </li>
    <li class="item-content item-input">
      <div class="item-inner">
        <div class="item-input-wrap">
          ...
          <input type="text" name="lama_kerja[${counter}]">
          <span class="input-clear-button"></span>
        </div>
      </div>
    </li>
    <li class="item-content item-input">
      <div class="item-inner">
        <div class="item-input-wrap">
          ...
          <input type="text" name="pemberi_kerja[${counter}]">
          <span class="input-clear-button"></span>
        </div>
      </div>
    </li>`;
          ...
          <li class="item-content item-input">
            <div class="item-inner">
              <div class="row">
                ...
                <div class="col-20">
                  <a id="${counter}" onclick="upload_file_pindah(this.id)" class="button button-round button-fill" style="margin-top: 10px;">
                    <i class="f7-icons" style="font-size: 16pt; margin-top: 7px;">folder_fill</i>
                  </a>
                </div>
              </div>
...
function add_row_pasangan() {
  if (add_form_upload_pasangan_status == false) {
    ...
    var formupload_html =
      `<li data-index="${counter_pasangan}">
        <ul>
          <li class="item-content item-input">
            <div class="item-inner">
              <div class="row">
                ...
                <div class="col-20">
                  <a id="${counter_pasangan}" onclick="upload_file_pasangan(this.id)" class="button button-round button-fill" style="margin-top: 10px;">
                    <i class="f7-icons" style="font-size: 16pt; margin-top: 7px;">folder_fill</i>
                  </a>
                </div>
              </div>
          ...
          <li class="item-content item-input">
            <div class="item-inner">
              <div class="row">
                ...
                <div class="col-20">
                  <a id="${counter_pasangan}" onclick="delete_row_pasangan(this.id)" class="delete_row_pasangan button button-round button-fill color-red" style="margin-top: 10px;">
                    <i class="f7-icons" style="font-size: 16pt; margin-top: 7px;">trash_fill</i>
                  </a>
                </div>
              </div>
...
function uploadProfile(uploadfileid) {
  Attachment.openGallery({
    onSuccess: function (fileURL, fileName) {
      let params = { subdir: 'pendaftar' };
      Attachment.upload(fileURL, fileName, params, function (success) {
        // var data = JSON.parse(success.response);
        var data = JSON.parse(success.data);
        addformupload_status = true;
...
function upload_file_daftar(uploadfileid) {
  Attachment.openGallery({
    onSuccess: function (fileURL, fileName) {
      let params = { subdir: 'pendaftar' };
      Attachment.upload(fileURL, fileName, params, function (success) {
...
function uploadpasfoto(uploadfileid) {
  Attachment.openGallery({
    onSuccess: function (fileURL, fileName) {
      let params = { subdir: 'pas_foto_ktp' };
      Attachment.upload(fileURL, fileName, params, function (success) {
        // var data = JSON.parse(success.response);
        var data = JSON.parse(success.data);
        addformupload_status = true;
...
function uploadfotokpk(uploadfileid) {
  Attachment.openGallery({
    onSuccess: function (fileURL, fileName) {
      let params = { subdir: 'kartu_pencari_kerja' };
      Attachment.upload(fileURL, fileName, params, function (success) {
        // var data = JSON.parse(success.response);
        var data = JSON.parse(success.data);
        addformupload_status = true;
...
function uploadLogo(uploadfileid) {
  Attachment.openGallery({
    onSuccess: function (fileURL, fileName) {
      let params = { subdir: 'layanan' };
      Attachment.upload(fileURL, fileName, params, function (success) {
        ...
        $$('.logo').val(data[0].code);
        var preview_files = '<a id="preview_logo_button" onclick="preview_logo(' + data[0].id + ')" class="button button-round button-fill color-orange" style="margin-top: 10px;"><i class="f7-icons" style="font-size: 16pt; margin-top: 7px;">zoom_in</i></a>';
...
function uploadbuktibayar(uploadfileid) {
  Attachment.openGallery({
    onSuccess: function (fileURL, fileName) {
      let params = { subdir: 'bukti_bayar_imb' };
      Attachment.upload(fileURL, fileName, params, function (success) {
        // var data = JSON.parse(success.response);
        var data = JSON.parse(success.data);
        addformupload_status = true;
                  ...
                  <div class="row">
                    <div class="col-60">
                      <div class="item-inner">
                        <div class="item-input-wrap">
                          <input id="fileid${counter}" class="fileid" type="hidden" name="fileid[${counter}]">
                          <input class="filecode" id="filecode${counter}" type="hidden" readonly="" name="filecode[]" value="${item.code}">
                          <input class="fileurl" id="fileurl${counter}" value="${item.file_name}" type="text" name="fileurl[${counter}]" ${disable} placeholder="URL file">
                        </div>
                      </div>
                    </div>
                    <div class="col-20 preview_files">
                      <a id="${counter}" onclick="preview_files(${item.id})" class="button button-round button-fill color-orange" style="margin-top: 10px;">
                        <i class="f7-icons" style="font-size: 16pt; margin-top: 7px;">zoom_in</i>
                      </a>
                    </div>
                    <div class="col-20">
                      <a id="${counter}" ${hiding} onclick="uploadfile(this.id)" class="button button-round button-fill" style="margin-top: 10px;">
                        <i class="f7-icons" style="font-size: 16pt; margin-top: 7px;">folder_fill</i>
                      </a>
                    </div>
                  </div>
                ...
                <div class="item-inner">
                  <div class="row">
                    ...
                    <div class="col-60">
                      <div class="item-inner">
                        <div class="item-input-wrap">
                          <input type="text" name="keteranganid[]" value="${item.desc}" ${disable} placeholder="Keterangan File">
                        </div>
                      </div>
                    </div>
                    <div class="col-20">
                      <a id="${counter}" ${hiding} onclick="deleterow(this.id)" class="button button-round button-fill color-red" style="margin-top: 10px;">
                        <i class="f7-icons" style="font-size: 16pt; margin-top: 7px;">trash_fill</i>
                      </a>
                    </div>
                  </div>
              ...
              <li class="item-content item-input">
                <div class="item-inner">
                  <div class="row">
                    <div class="col-60">
                      <div class="item-inner">
                        <div class="item-input-wrap">
                          ...
                          <input class="file_code_pasangan" id="file_code_pasangan${counter}" type="hidden" readonly="" name="file_code_pasangan[]" value="${item.code}">
                          <input class="fileurl_pasangan" id="fileurl_pasangan${counter}" value="${item.file_name}" type="text" name="fileurl_pasangan[${counter}]" ${disable} placeholder="URL file">
                        </div>
                      </div>
                    </div>
                    <div class="col-20 preview_files">
                    ...
                    <div class="col-20">
                      <a id="${counter}" ${hiding} onclick="upload_file_pasangan(this.id)" class="button button-round button-fill" style="margin-top: 10px;">
                        <i class="f7-icons" style="font-size: 16pt; margin-top: 7px;">folder_fill</i>
                      </a>
                    </div>
                  </div>
                ...
                <div class="item-inner">
                  <div class="row">
                    ...
                    <div class="col-60">
                      <div class="item-inner">
                        <div class="item-input-wrap">
                          <input type="text" name="keteranganid_pasangan[]" value="${item.desc}" ${disable} placeholder="Keterangan File">
                        </div>
                      </div>
                    </div>
                    <div class="col-20">
                      <a id="${counter}" ${hiding} onclick="delete_row_pasangan(this.id)" class="delete_row_pasangan button button-round button-fill color-red" style="margin-top: 10px;">
                        <i class="f7-icons" style="font-size: 16pt; margin-top: 7px;">trash_fill</i>
                      </a>
                    </div>
                  </div>
                    ...
                    <div class="col-60">
                      <div class="item-inner">
                        <div class="item-input-wrap">
                          <input id="fileid${counter}" class="fileid" type="hidden" name="fileid[${counter}]">
                          <input class="filecode" id="filecode${counter}" type="hidden" readonly="" name="filecode[]" value="${item.code}">
                          <input class="fileurl" id="fileurl${counter}" value="${item.file_name}" type="text" name="fileurl[${counter}]" placeholder="URL file">
                        </div>
                      </div>
                    </div>
                    <div class="col-20 preview_files">
                      <a id="${counter}" onclick="preview_ktp(${item.id})" class="button button-round button-fill color-orange" style="margin-top: 10px;">
                        <i class="f7-icons" style="font-size: 16pt; margin-top: 7px;">zoom_in</i>
                      </a>
                    </div>
                    <div class="col-20">
                ...
                <div class="item-inner">
                  <div class="row">
                    ...
                    <div class="col-60">
                      <div class="item-inner">
                        <div class="item-input-wrap">
                          <input type="text" name="keteranganid[]" value="${item.desc}" placeholder="Keterangan File">
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    if (image_url == null) {
      ...
      var the_preview_files = app.popup.create({
        content: '<div class="popup">' +
          '<div class="block">' +
          '<p class="row"><a href="#" class="col-25 button button-raised button-fill popup-close">TUTUP</a></p>' +
          '<img src="' + site_url_image_pindah + image_url + '/' + userencoded + '" width="100%">' +
          '</div>' +
          '</div>',
      });
      the_preview_files.open();
    ...
    if (image_url == null) {
      ...
      var the_preview_files = app.popup.create({
        content: '<div class="popup">' +
          '<div class="block">' +
          '<p class="row"><a href="#" class="col-25 button button-raised button-fill popup-close">TUTUP</a></p>' +
          '<img src="' + site_url_image_pas_foto_ktp + image_url + '/' + userencoded + '" width="100%">' +
          '</div>' +
          '</div>',
      });
      the_preview_files.open();
    ...
    if (image_url == null) {
      ...
      var the_preview_files = app.popup.create({
        content: '<div class="popup">' +
          '<div class="block">' +
          '<p class="row"><a href="#" class="col-25 button button-raised button-fill popup-close">TUTUP</a></p>' +
          '<img src="' + site_url_image_pas_foto_kpk + image_url + '/' + userencoded + '" width="100%">' +
          '</div>' +
          '</div>',
      });
      the_preview_files.open();
    ...
    if (image_url == null) {
      ...
      var the_preview_files = app.popup.create({
        content: '<div class="popup">' +
          '<div class="block">' +
          '<p class="row"><a href="#" class="col-25 button button-raised button-fill popup-close">TUTUP</a></p>' +
          '<img src="' + site_url_image_pas_foto_kua + image_url + '/' + userencoded + '" width="100%">' +
          '</div>' +
          '</div>',
      });
      the_preview_files.open();
    ...
    if (image_url == null) {
      ...
      var the_preview_files = app.popup.create({
        content: '<div class="popup">' +
          '<div class="block">' +
          '<p class="row"><a href="#" class="col-25 button button-raised button-fill popup-close">TUTUP</a></p>' +
          '<img src="' + site_url_image_pas_foto_tdp + image_url + '/' + userencoded + '" width="100%">' +
          '</div>' +
          '</div>',
      });
      the_preview_files.open();
    ...
    if (image_url == null) {
      ...
      var the_preview_files = app.popup.create({
        content: '<div class="popup">' +
          '<div class="block">' +
          '<p class="row"><a href="#" class="col-25 button button-raised button-fill popup-close">TUTUP</a></p>' +
          '<img src="' + site_url_image_bukti_bayar_imb + image_url + '/' + userencoded + '" width="100%">' +
          '</div>' +
          '</div>',
      });
      the_preview_files.open();
              ...
              <li class="item-content item-input">
                <div class="item-inner">
                  <div class="row">
                    ...
                    <div class="col-20 preview_files">
                      <a id="${index}" onclick="preview_files(${attachments[counter].id})" class="button button-round button-fill color-orange" style="margin-top: 10px;">
                        <i class="f7-icons" style="font-size: 16pt; margin-top: 7px;">zoom_in</i>
                      </a>
                    </div>
                    ${uploadbtn}
