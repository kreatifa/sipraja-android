var packing = {
    path: "/tipe-f/packing/:kode_toko",
    url: "./pages/tipe-f/packing/index.html",
    name: "packing",
    on: {
        pageInit: function () {
            ...
            var packing = '';
            app.request.post(site_url_mobile_layanan + '/packing/menu/' + kode_toko, iamthedoor, function (response) {
                ...
                for (key in fieldImage) {
                    ...
                    packing += `<div class="col-50">
                        <a href="/tipe-f/packing/list_menu/${fieldImage[key]}/${kode_toko}" class="link icon-only">
                            <article class="photo">
...
var orderan = {
    path: "/tipe-f/packing/list_menu/orderan/:kode_toko",
    url: "./pages/tipe-f/packing/orderan.html",
    name: "orderan",
    on: {
        pageInit: function () {
            const kode_toko = mainView.router.currentRoute.params.kode_toko;
            ...
            var statusselect = app.smartSelect.create({
                ...
                on: {
                    close: function () {
                        ...
                        datatables.context[0].ajax.url = site_url_mobile_layanan + '/packing/get_data_orderan/' + $$('#statusselect').val() + '/' + kode_toko;
            ...
            var datatables = $('#table_orderan').DataTable({
                "serverSide": true,
                "ajax": {
                    "url": site_url_mobile_layanan + '/packing/get_data_orderan/0/' + kode_toko,
                    "data": iamthedoor,
                    "type": "GET"
                },
                "columns": [
                ...
                "rowCallback": function (row, data) {
                    $('td:eq(0)', row).html(`<a href="/tipe-f/edit_orderan/0/${data.id}" class="button button-small button-fill color-blue"><i class="icon f7-icons" style="font-size: 12pt;">pencil_circle_fill</i> Edit</a>`);
                ...
                on: {
                    open: function () {
                        $$('#form_pembatalan_pesanan #save_pembatalan').on('click', function () {
                            ...
                            app.request.post(site_url_mobile_layanan + '/packing/action_pembatalan', ajax_data, function (response) {
...
var edit_orderan = {
    path: "/tipe-f/edit_orderan/:kode/:id",
    url: "./pages/tipe-f/packing/edit_orderan.html",
    name: "edit_orderan",
    on: {
        pageInit: function () {
            ...
            app.request.post(site_url_mobile_layanan + '/packing/get_orderan_byid/' + kode + '/' + id, iamthedoor, function (response) {
                $$('#back').attr('href', '/tipe-f/packing/' + response.pesanan[0].kode_toko + '');
                ...
                response.pesanan.forEach(async function (val, index) {
                    produk += `<li id="checkout-${val.id}">
                        ...
                        <label class="item-content">
                            <a href="/tipe-f/packing/detail/${val.id_product}" class="item-link item-content" style="margin-right: 150px;">
            ...
            $$('#simpan').on('click', function () {
                ...
                app.request.post(site_url_mobile_layanan + '/packing/save_packing/' + id, ajax_data, function (response) {
                    if (response) {
                        app.dialog.alert('Berhasil packing produk', function () {
                            mainView.router.back();
                            $('#table_orderan').DataTable().ajax.reload();
                        })
                    }
...
var history_toko = {
    path: "/tipe-f/packing/list_menu/history/:kode_toko",
    url: "./pages/tipe-f/packing/history.html",
    name: "history",
    on: {
        pageInit: function () {
            const kode_toko = mainView.router.currentRoute.params.kode_toko;
            ...
            var datatables = $('#table_history').DataTable({
                "serverSide": true,
                "ajax": {
                    "url": site_url_mobile_layanan + '/packing/get_data_history/' + kode_toko,
                    "data": iamthedoor,
                    "type": "GET"
                },
                "columns": [
                ...
                "rowCallback": function (row, data) {
                    $('td:eq(0)', row).html(`<a href="/tipe-f/edit_orderan/0/${data.id}" class="button button-small button-fill color-green"><i class="icon f7-icons" style="font-size: 12pt;">pencil_circle_fill</i> Detail</a>`);
            ...
            $$('#ajukan_claim').on('click', function () {
                ...
                app.request.post(site_url_mobile_layanan + '/packing/claim', ajax_data, function (response) {
                    app.dialog.close();
...
var serah_terima = {
    path: "/tipe-f/packing/list_menu/serah_terima/:kode_toko",
    url: "./pages/tipe-f/packing/serah_terima.html",
    name: "serah_terima",
    on: {
        pageInit: function () {
            const kode_toko = mainView.router.currentRoute.params.kode_toko;
            ...
            var datatables = $('#table_serah_terima').DataTable({
                "serverSide": true,
                "ajax": {
                    "url": site_url_mobile_layanan + '/packing/get_data_serah_terima/1/' + kode_toko,
                    "data": iamthedoor,
                    "type": "GET"
                },
                "columns": [
                    ...
                    open: function () {
                        $$('#simpan').on('click', function () {
                            ...
                            if ($$('#form_serah_terima')[0].checkValidity() == true) {
                                ...
                                app.request.post(site_url_mobile_layanan + '/packing/save_serah_terima', ajax_data, function (response) {
                                    app.dialog.alert(response.message, function () {
                                        dynamicSheet.close();
...
var claim_penjual = {
    path: "/tipe-f/packing/list_menu/claim/:kode_toko",
    url: "./pages/tipe-f/packing/claim_penjual.html",
    name: "claim penjual",
    on: {
        pageInit: function () {
            const kode_toko = mainView.router.currentRoute.params.kode_toko;
            ...
            var datatables = $('#table_claim_penjual').DataTable({
                "serverSide": true,
                "ajax": {
                    "url": site_url_mobile_layanan + '/packing/get_data_claim_penjual/' + kode_toko,
                    "data": iamthedoor,
                    "type": "GET"
                },
                "columns": [
            ...
            $('#table_claim_penjual').on('click', '.detail_pesanan', function () {
                var detail_produk = '';
                app.request.post(site_url_mobile_layanan + '/packing/detail_produk/' + $$(this).data('pesanan'), iamthedoor, async function (response) {
...
var komplain_penjual = {
    path: "/tipe-f/packing/list_menu/komplain/:kode_toko",
    url: "./pages/tipe-f/packing/komplain.html",
    name: "komplain",
    on: {
        pageInit: function () {
            const kode_toko = mainView.router.currentRoute.params.kode_toko;
            ...
            var statusselect = app.smartSelect.create({
                ...
                on: {
                    close: function () {
                        app.dialog.preloader('Loading...');
                        datatables.context[0].ajax.url = site_url_mobile_layanan + '/packing/get_data_komplain/' + $$('#statusselect').val() + '/' + kode_toko;
            ...
            var datatables = $('#komplain_table').DataTable({
                "serverSide": true,
                "ajax": {
                    "url": site_url_mobile_layanan + '/packing/get_data_komplain/0/' + kode_toko,
                    "data": iamthedoor,
                    "type": "GET"
                },
                "columns": [
                ...
                searching: false,
                "rowCallback": function (row, data) {
                    $('td:eq(0)', row).html(`<a href="/tipe-f/packing/edit_komplain/${data.id}/packing" class="button button-small button-fill color-blue"><i class="icon f7-icons" style="font-size: 12pt;">pencil_circle_fill</i> Jawab</a>`);
...
var komplain_edit = {
    path: "/tipe-f/packing/edit_komplain/:id/:kode",
    url: "./pages/tipe-f/packing/edit_komplain.html",
    name: "edit_komplain",
    on: {
        pageInit: function () {
            let id = mainView.router.currentRoute.params.id;
            ...
            app.dialog.preloader('Loading...');
            app.request.post(site_url_mobile_layanan + '/packing/get_komplain/' + id, iamthedoor, function (response) {
                app.dialog.close();
            ...
            $$('#simpan').on('click', function () {
                ...
                if ($$('#edit_komplain_packing')[0].checkValidity() == true) {
                    ...
                    app.request.post(site_url_mobile_layanan + '/packing/save_komplain/' + id + '/' + kode, ajax_data, function (response) {
                        app.dialog.alert(response.message, function () {
                            mainView.router.back();
...
var pembatalan = {
    path: "/tipe-f/packing/list_menu/pembatalan/:kode_toko",
    url: "./pages/tipe-f/packing/pembatalan.html",
    name: "pembatalan",
    on: {
        pageInit: function () {
            const kode_toko = mainView.router.currentRoute.params.kode_toko;
            ...
            var datatables = $('#table_pembatalan').DataTable({
                "serverSide": true,
                "ajax": {
                    "url": site_url_mobile_layanan + '/packing/get_data_pembatalan/pembatalan/' + kode_toko,
                    "data": iamthedoor,
                    "type": "GET"
                },
                "columns": [
                ...
                "rowCallback": function (row, data) {
                    $('td:eq(0)', row).html(`<a href="/tipe-f/edit_orderan/1/${data.id}" class="button button-small button-fill color-green"><i class="icon f7-icons" style="font-size: 12pt;">pencil_circle_fill</i> Detail</a>`);
                    $("td:eq(3)", row).html('Rp ' + toIdrFormat(data.harga_barang));
                }
            });
        }
...
var tb_pengembalian = {
    path: "/tipe-f/packing/list_menu/pengembalian/:kode_toko",
    url: "./pages/tipe-f/packing/pengembalian.html",
    name: "pengembalian",
    on: {
        pageInit: function () {
            const kode_toko = mainView.router.currentRoute.params.kode_toko;
            ...
            var datatables = $('#table_pengembalian').DataTable({
                "serverSide": true,
                "ajax": {
                    "url": site_url_mobile_layanan + '/packing/get_data_pengembalian/pengembalian/' + kode_toko,
                    "data": iamthedoor,
                    "type": "GET"
                },
                "columns": [
                ...
                "rowCallback": function (row, data) {
                    $('td:eq(0)', row).html(`<a href="/tipe-f/edit_orderan/2/${data.id}" class="button button-small button-fill color-green"><i class="icon f7-icons" style="font-size: 12pt;">pencil_circle_fill</i> Detail</a>`);
                    $("td:eq(3)", row).html('Rp ' + toIdrFormat(data.harga_barang));
                }
            });
        }
